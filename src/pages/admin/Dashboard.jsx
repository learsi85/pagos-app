...
export default function Dashboard() {
  ...
  return (
    <PageShell>
      ...
      {/* KPI cards — texto adaptable, nunca desborda */}
      <div style={s.kpiGrid}>
      ...
      {/* Pagos recientes — scroll horizontal en móvil */}
...
function KpiCard({ label, value, color, money }) {
  return (
    <div style={{ ...s.kpiCard, borderTop: `3px solid ${color}` }}>
      {/* fontSize adaptable: más pequeño para montos largos */}
      <div style={{
        ...s.kpiValue,
        color,
        fontSize: money ? 18 : 26,
...
const s = {
  ...
  kpiGrid:    {
    display: 'grid',
    // En móvil 2 columnas, en desktop auto-fill
  ...
  kpiCard:    {
    ...
    minWidth: 0, // evita que desborde el grid
    overflow: 'hidden',
  },
  ...
  vencProd:   { fontSize: 12, color: '#718096', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
