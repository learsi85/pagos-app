              ...
              <tbody>
                {productos.map((p) => (
                  ...
                  >
                    ...
                    <td style={{ ...s.td, color: '#718096', maxWidth: 200, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                      {p.Descripcion || '—'}
                    </td>
                    <td style={{ ...s.td, fontWeight: 600, color: '#2b6cb0', whiteSpace: 'nowrap' }}>
                      {fmt.money(p.PrecioBase)}
                    </td>
                    <td style={s.td}>
                      <span style={{
        ...
        <div style={s.overlay} onClick={(e) => e.target === e.currentTarget && setModal(false)}>
          <div style={s.modal}>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <F label="Descripción">
                <textarea {...register('Descripcion')} style={{ ...s.input, minHeight: 70, resize: 'vertical' }} />
              </F>
...
const s = {
  ...
  modal:       { background: '#fff', borderRadius: 12, padding: '28px 24px', width: '100%', maxWidth: 460, maxHeight: '90vh', overflowY: 'auto' },
